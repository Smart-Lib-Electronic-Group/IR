 ...
 */
    ...
    #define IS_LL_SPI_NSS(__VALUE__) (((__VALUE__) == LL_SPI_NSS_SOFT) || ((__VALUE__) == LL_SPI_NSS_hard_recv_input) || ((__VALUE__) == LL_SPI_NSS_HARD_OUTPUT))
...
void LL_SPI_StructInit(LL_SPI_InitTypeDef* SPI_InitStruct)
{
  ...
  SPI_InitStruct->NSS               = LL_SPI_NSS_hard_recv_input;
...
ErrorStatus LL_I2S_InitFullDuplex(SPI_TypeDef* I2Sxext, LL_I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  if (LL_I2S_IsEnabled(I2Sxext) == 0x00000000U)
  {
    ...
    /* Write to SPIx I2SCFGR */
    MODIFY_REG(I2Sxext->I2SCFGR, I2S_I2SCFGR_CLEAR_MASK, I2S_InitStruct->Standard | I2S_InitStruct->DataFormat | I2S_InitStruct->ClockPolarity | SPI_I2SCFGR_I2SMOD | mode);
