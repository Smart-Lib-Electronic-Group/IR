...
#define configQUEUE_REGISTRY_SIZE               32              /* 定义可以注册的信号量和消息队列的大小, 默认: 0 */
...
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS 1               /* 定义线程局部指针变量的个数, 默认: 0 */
...
#elif STM32F429
  #define configTOTAL_HEAP_SIZE ((size_t)(132 * 1024)) /* FreeRTOS堆中可用的RAM总量, 单位: Byte, 无默认需定义 */
#elif STM32H743
  #define configTOTAL_HEAP_SIZE ((size_t)(256 * 1024)) /* FreeRTOS堆中可用的RAM总量, 单位: Byte, 无默认需定义 */
#endif
...
#define INCLUDE_xQueueGetMutexHolder        1 /* 获取互斥信号量持有者 */
